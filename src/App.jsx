...
const App = () => {
    ...
    const inputAutoPrice =  useCallback((e) => {
        setAutoPrise(e.target.value);
    }, [autoPrice]);
    useEffect(() => {
        setW1((autoPrice - 1000000) / 5000000 * document.getElementById('line1').offsetWidth + 'px');
    }, [autoPrice])
    ...
    useEffect(() => {
        ...
        setW2((percent - 10) / 50 * document.getElementById('line2').offsetWidth + 'px');
    }, [percent])
    ...
    useEffect(() => {
        setW3((period - 1) / 59 * document.getElementById('line3').offsetWidth + 'px');
    }, [period])
                ...
                <div className={inputStyle.input__main__container}>
                    <div className={inputStyle.input__line__container}>
                        ...
                        <div className={inputStyle.input__line____container}>
                            <input className={inputStyle.input__line} name="line" value={autoPrice} onChange={inputAutoPrice} onMouseLeave={changeAutoPrice}/>
                    ...
                    <div className={inputStyle.input__line__container}>
                        ...
                        <div className={inputStyle.input__line____container}>
                            <div className={inputStyle.input__line__passive}>{firstPayment}</div>
                ...
                <div className={finalStyle.final__main__container}>
                    <div className={finalStyle.final__small__container}>
                        <div className={finalStyle.final__small__block}>
                            ...
                            <div className={finalStyle.final__price}>{sum} ₽</div>
                        </div>

                        <div className={finalStyle.final__small__block}>
                            <div className={textStyle.small__text}>Ежемесячный платеж от</div>
                            <div className={finalStyle.final__price}>{monthlyPayment} ₽</div>
                        </div>
                    </div>
                    {
                        (meta == "initial") ?
